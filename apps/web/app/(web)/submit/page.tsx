...
export const metadata: Metadata = {
  ...
  description:
    "Gửi công cụ AI yêu thích của bạn để chia sẻ với cộng đồng. Giúp mọi người khám phá các giải pháp AI tuyệt vời.",
        ...
        <div className="mb-10 space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Bạn biết một công cụ AI xứng đáng được biết đến nhiều hơn? Gửi nó ngay để chúng tôi
              thêm vào thư viện công cụ.
            </p>
          </div>
          ...
          <div className="rounded-lg border p-4">
            <div className="prose prose-sm max-w-none dark:prose-invert">
              <p>
                <span className="font-medium">Lưu ý:</span> Tất cả các công cụ AI gửi lên phải đáp
                ứng các tiêu chí sau để được xuất bản:
              </p>
